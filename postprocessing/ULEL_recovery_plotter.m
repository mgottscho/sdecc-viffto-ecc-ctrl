concat_data = [
     avg_benchmark_successes_data_r1(1:10)...
     avg_benchmark_successes_data_r2(1:10)...
     avg_benchmark_successes_data_r3(1:10);...
     NaN NaN NaN;...
     mean(avg_benchmark_successes_data_r1) mean(avg_benchmark_successes_data_r2) mean(avg_benchmark_successes_data_r3);...
     avg_benchmark_successes_inst_r1(1:10)...
     avg_benchmark_successes_inst_r2(1:10)...
     avg_benchmark_successes_inst_r3(1:10);...
     NaN NaN NaN;...
