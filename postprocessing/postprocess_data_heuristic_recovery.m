...
%%%%%%%% CHANGE ME AS NEEDED %%%%%%%%%%%%
input_directory = 'D:\Dropbox\SoftwareDefinedECC\data\rv64g\data-recovery\offline-dynamic\hsiao1970\72,64\dbx-longest-run-pick-lowest-weight\crash-threshold-0.5\2016-11-12';
...
code_type = 'hsiao1970';
policy = 'dbx-longest-run-pick-lowest-weight';
...
for bench=1:num_benchmarks
    ...
    load([input_directory filesep architecture '-' benchmark '-data-heuristic-recovery.mat'], 'results_candidate_messages', 'success', 'could_have_crashed', 'success_with_crash_option','n','k');
