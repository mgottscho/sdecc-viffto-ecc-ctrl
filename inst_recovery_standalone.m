function [] = inst_recovery_standalone(architecture, n, k, original_message_bin, error_pattern_bin, policy, instruction_mnemonic_hotness, instruction_rd_hotness, crash_threshold, verbose, code_type)
