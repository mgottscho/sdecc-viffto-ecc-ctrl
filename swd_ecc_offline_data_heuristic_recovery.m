...
%   policy --           String: '[baseline-pick-random|hamming-pick-random|hamming-pick-longest-run|longest-run-pick-random|delta-pick-random|dbx-longest-run-pick-random|dbx-weight-pick-longest-run|dbx-longest-run-pick-lowest-weight]'
