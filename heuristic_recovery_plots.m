...
xlabel('Average Number of Valid (Filtered) Candidate Messages');
ylabel('Average Rate of Recovery');
title(['Rate of Heuristic Recovery for ' code_type ' (39,32) SECDED -- ' benchmark ' -- Filter-rank-filter-rank']);
