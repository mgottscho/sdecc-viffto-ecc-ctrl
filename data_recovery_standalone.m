...
data_recovery('rv64g', num2str(n), num2str(k), original_message_bin, candidate_correct_messages_bin, policy, cacheline_bin, message_blockpos, crash_threshold, num2str(verbose_recovery)); % Don't need return values.
